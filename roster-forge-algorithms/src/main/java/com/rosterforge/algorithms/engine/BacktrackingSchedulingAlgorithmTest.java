...
public class BacktrackingSchedulingAlgorithmTest {

    @Test
    void shouldGenerateValidRosterForQualifiedEmployee() {
        ...
        BacktrackingSchedulingAlgorithm algorithm = new BacktrackingSchedulingAlgorithm(validator, scorer);
